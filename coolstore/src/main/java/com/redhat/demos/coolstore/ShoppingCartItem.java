...
public class ShoppingCartItem implements java.io.Serializable
{
   ...
   private com.redhat.demos.coolstore.ShoppingCart shoppingCart;
   ...
   public com.redhat.demos.coolstore.ShoppingCart getShoppingCart()
   {
      return this.shoppingCart;
   }

   public void setShoppingCart(com.redhat.demos.coolstore.ShoppingCart shoppingCart)
   {
   ...
   public ShoppingCartItem(java.lang.String itemId, java.lang.String name,
         ...
         com.redhat.demos.coolstore.ShoppingCart shoppingCart)
   {
      this.itemId = itemId;
      this.name = name;
      this.price = price;
