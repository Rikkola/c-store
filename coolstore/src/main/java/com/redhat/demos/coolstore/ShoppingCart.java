...
public class ShoppingCart implements java.io.Serializable
{
   ...
   private java.util.List<com.redhat.demos.coolstore.ShoppingCartItem> shoppingCartItemList;
   ...
   public java.util.List<com.redhat.demos.coolstore.ShoppingCartItem> getShoppingCartItemList()
   {
      return this.shoppingCartItemList;
   }

   public void setShoppingCartItemList(
         java.util.List<com.redhat.demos.coolstore.ShoppingCartItem> shoppingCartItemList)
   {
